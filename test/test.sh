...
execute_test test/jnn_dtw_real_dna.txt test/data/jnn_dtw_real_dna.exp 0 || die "diff failed"
...
# execute_test test/jnn_dtw_real_dna.txt test/data/jnn_dtw_real_rna.exp 0 || die "diff failed"
...
# execute_test test/jnn_dtw_real_rna.txt test/data/jnn_dtw_real_rna.exp 0 || die "diff failed"

# realtime prefix

echo "DNA real prefix"
ex ./sigfish real test/sp1_dna.blow5 > test/prefix_real_dna.txt || die "Running the tool failed"
execute_test test/prefix_real_dna.txt test/data/prefix_dna.exp 0

# echo "RNA real prefix"
# ex ./sigfish real test/sequin_rna.blow5 > test/prefix_real_rna.txt || die "Running the tool failed"
# execute_test test/prefix_real_rna.txt test/data/prefix_rna.exp 0 || die "diff failed"
